...
import { MapPin, Building2, User, X, Loader2, AlertCircle, Hexagon, RefreshCw, Maximize2, Minimize2, ExternalLink } from "lucide-react";
        ...
        <DialogHeader className="p-4 pb-2">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="ghost" size="icon" className="h-8 w-8" onClick={openPopout} title="Open in new window">
              ...
              <div className="flex items-center gap-2">
                <Switch id="h3-toggle" checked={showH3Overlay} onCheckedChange={setShowH3Overlay} />
      ...
      <Dialog open={showFailedDialog} onOpenChange={setShowFailedDialog}>
        <DialogContent className="max-w-md">
          ...
          <div className="max-h-[60vh] overflow-y-auto pr-2">
            <p className="text-sm text-muted-foreground mb-4">The following addresses could not be located. Please check for typos or missing information.</p>
