...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      budget_forecasts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "budget_forecasts_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      company_meetings: {
        ...
        Relationships: [
          {
            foreignKeyName: "company_meetings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      spiff_prizes: {
        ...
        Relationships: [
          {
            foreignKeyName: "spiff_prizes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      spiff_program: {
        ...
        Relationships: [
          {
            foreignKeyName: "spiff_program_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      spiff_warranties: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "spiff_warranties_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      video_meetings: {
        ...
        Relationships: [
          {
            foreignKeyName: "video_meetings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      is_global_developer: { Args: { _user_id: string }; Returns: boolean }
      is_tenant_member: {
    ...
    Enums: {
      ...
      tenant_member_status: "active" | "pending" | "invited" | "revoked"
    }
    CompositeTypes: {
      [_ in never]: never
    }
